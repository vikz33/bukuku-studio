...
export const ISI_IDS = ['lineType','footerMode','customFooterText','customHeaderText','lineColor','watermarkText','watermarkType','sizeWatermarkImage','showPageNumber','showDateField','showNumberField','showFooter','showDecoration','showWatermark','totalPages','customTotalPages','showHeader','headerColor','footerColor','showTopLine', 'kdpMode', 'kdpPreset', 'useBleed', 'useGutter'];